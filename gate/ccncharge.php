...
if($rtr<6)
{
if(($msg=="generic_decline") || ($msg =="fraudlent") || ($msg =="do_not_honor"))
{
    $rtr++;
goto retry;
}
...
$stl 𝘙𝘦𝘴𝘱𝘰𝘯𝘴𝘦 » [𝘊𝘊𝘕-𝘊𝘏𝘈𝘙𝘎𝘌𝘋 𝘚𝘜𝘊𝘊𝘌𝘚𝘚!] <br>
$stl 𝘊𝘏𝘈𝘙𝘎𝘌𝘋 𝘈𝘮𝘰𝘶𝘯𝘵 » $sy $amt $appr  <br>
$stl 𝘊𝘰𝘶𝘯𝘵𝘳𝘺 » $country <br>
$stl 𝘈𝘱𝘪 𝘉𝘠 » @A_AAQ ××<br>
$stl 𝘙𝘦𝘤𝘦𝘪𝘱𝘵  » <code><a href=$receipturl>Here</a></code><br>
";
...
$stl 𝘙𝘦𝘴𝘱𝘰𝘯𝘴𝘦 » [𝘊𝘊𝘕-𝘊𝘏𝘈𝘙𝘎𝘌𝘋-𝘚𝘜𝘊𝘊𝘌𝘚𝘚!]
...
elseif ((strpos($r2, '"code": "fraudlent"')) || (strpos($r3, '"code": "fraudlent"')))
{
 goto fuck;
...
elseif (strpos($r2, "testmode_charges_only")) 
{
  goto fuck;
  
}
elseif (strpos($r2, "Amount")) 
{
  goto fuck;
   
}

elseif ((strpos($r2, 'invalid_cvc')) || (strpos($r1, 'invalid_cvc'))) 
{
    goto fuck;
